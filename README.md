...
| __10_ufbx__: loading .fbx file using [ufbx](https://github.com/ufbx/ufbx) and [odin-ufbx-bindings](https://github.com/cshenton/odin-ufbx), also [blinn-phong shading](https://learnopengl.com/Lighting/Basic-Lighting) | __11_entities__: multiple moving 3d meshes in one scene                                                               |
...
| __12_pbr__: pbr shading                                                                                                                                                                                                | __13_cel__: cel shading and shader re-compilation                                                                     |
| _not yet working_                                                                                                                                                                                                      | <img src="https://github.com/phil-stein/odin-opengl-examples/blob/main/files/12_cel.png" alt="logo" width="400">      |
| __14_normal__: normal mapping                                                                                                                                                                                          |                                                                                                                       |
| <img src="https://github.com/phil-stein/odin-opengl-examples/blob/main/files/14_normal.png" alt="logo" width="400">                                                                                                    |                                                                                                                       |


|                                    |   |
| ---------------------------------- | - |
| __XX_style_XX__: style experiment  | - |
| not relevant                       | - |
